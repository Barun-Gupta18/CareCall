              ...
              {category &&
                <table className="table">
                  <tbody>
                    <tr>
                      <td>
                        <h3 style={{ color: '#FFFFFF' }}><b>Service Info</b></h3>
                      </td>
                    ...
                    <tr>
                      ...
                      <td style={{ color: '#FFFFFF' }}>{category.categoryname}</td>
                    </tr>
                    <tr>
                      <th className="text-end" style={{ color: '#FFFFFF' }}>Description :</th>
                      <td style={{ color: '#FFFFFF' }}>{category.description}</td>
                    </tr>
                    {/* <tr>
                      <th className="text-end" style={{ color: '#FFFFFF' }}>Brief Description :</th>
                      <td style={{ color: '#FFFFFF' }}>{category.briefDescription}</td>
                    </tr> */}
                  </tbody>
                </table>
              }
