...
function PartnerBookingCompleted() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  async function goMoreDetails(value) {
    navigate("/partner/more-details", { state: { value } });
  }
  ...
  return (
    <div style={styles.container}>
      <h2 style={{ color: "#333", marginBottom: "20px", fontWeight: "700" }}>
        Confirmed Bookings
      </h2>
      <table style={styles.table}>
        <thead style={styles.tableHead}>
          <tr>
            ...
            <th style={styles.tableHeader}>P-Email</th>
            <th style={styles.tableHeader}>U-Name</th>
            <th style={styles.tableHeader}>U-Email</th>
...
export default PartnerBookingCompleted;
